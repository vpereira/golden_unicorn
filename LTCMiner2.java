...
// ** byteArrayToHexString ***
    ...
    public static void hexStringToByteArray(String s, byte[] data) throws NumberFormatException {
...
// ******* getWork *************************************************************
	...
	getTimeW = getTimeW * 0.99 + 1;
        ...
        try {
	    hexStringToByteArray(jsonParse(response,"data"), dataBuf2);
	...
	try {
		...
		targetBuf = hexStringToByteArray(str);
	    }
	    else {
		hexStringToByteArray("fffffffffffffffffffffffffffffffffffffffffffffffffffff0f0ff0f0000", targetBuf);
	    }
	}
	catch ( Exception e ) {
	    hexStringToByteArray("fffffffffffffffffffffffffffffffffffffffffffffffffffff0f0ff0f0000", targetBuf);	
...
// ******* submitWork **********************************************************
	...
	//dataBuf2 is the big endian version from dataBuf. We must as well switch the nonce and its what we are doing here
	d[79] = (byte) (n >>  0);
	d[78] = (byte) (n >>  8);
	d[77] = (byte) (n >> 16);
	d[76] = (byte) (n >> 24);
...
//  IT MUST BE FIXED
	...
	synchronized (ztex) {
		...
		// shouldn't occur
    	    ...
    	    ztex.vendorCommand2( 0x80, "Send hash data", 0, 0, sendBuf, sendBuf.length );
    	}
...
// hash is hardwired to zero. We are getting the nonce and the golden nonce
	...
	//dmsg("goldenNonce = " + intToHexStr(goldenNonce[0]));
